...
import { Product, ProductFeaturesSection } from '../../interfaces/product';
...
export class ProductComponent implements OnInit {
    ...
    @Input() set product(value: Product) {
        ...
        this.images = [
            {
                id: 'assets/images/products/product-1-1.jpg',
                url: 'assets/images/products/product-1.jpg',
                active: true
            },
            {
                id: 'assets/images/products/product-2-1.jpg',
                url: 'assets/images/products/product-2.jpg',
                active: false
            },
            {
                id: 'assets/images/products/product-3-1.jpg',
                url: 'assets/images/products/product-3.jpg',
                active: false
            },
            {
                id: 'assets/images/products/product-4-1.jpg',
                url: 'assets/images/products/product-4.jpg',
                active: false
            },
        ];
        // this.images = this.dataProduct.images ? this.dataProduct.images.map((url, index) => {
        //     return {
        //         id: index.toString(),
        //         url,
        //         active: index === 0
