...
export class AppComponent implements AfterViewInit, OnInit {
    ...
    ngOnInit(): void {
        ...
        this.cart.onAdding$.subscribe(product => {
            this.toastr.success(`Product "${product.productId}" added to cart!`);
        });
        this.compare.onAdding$.subscribe(product => {
            this.toastr.success(`Product "${product.productId}" added to compare!`);
        });
        this.wishlist.onAdding$.subscribe(product => {
            this.toastr.success(`Product "${product.productId}" added to wish list!`);
        });
    }
